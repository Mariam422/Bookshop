...
//               key={star}
//               className={
//                 star <= Math.round(rating) ? "text-yellow-400" : "text-gray-500"
//               }
//             />
//           ))}
...
//       <div className="flex flex-col sm:items-end justify-between gap-3 sm:gap-2">
//         {book.discount && (
...
//             hover:bg-pink-600 w-full sm:w-auto
//           "
//           >
...
//           <button
//             className="
//             border rounded-lg p-2 hover:bg-pink-100 text-pink-600
